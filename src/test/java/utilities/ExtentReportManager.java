...
public class ExtentReportManager implements ITestListener {
    ...
    /*	try {
    	    ...
    	    email.setAuthenticator(new DefaultAuthenticator("dmandar86@gmail.com", "password"));
    	    email.setSSLOnConnect(true);
    	    email.setFrom("dmandar86@gmail.com"); // Sender
    	    email.setSubject("Test Results");
    	    email.setMsg("Please find Attached Report...");
    	    email.addTo("ns060486@gmail.com"); // Receiver
